...
namespace LoopMcpServer.Settings.Editor
{
    /// <summary>
    /// Custom editor for LoopMcpServerSettings with assembly selector UI
    /// </summary>
    [CustomEditor(typeof(LoopMcpServerSettings))]
    public class LoopMcpServerSettingsEditor : UnityEditor.Editor
    {
        ...
        {
            var settings = (LoopMcpServerSettings)target;
            ...
            if (_showDefaultAssemblies)
            {
                ...
                GUI.enabled = false;
                foreach (var assemblyName in LoopMcpServerSettings.DefaultAssemblyNames)
                {
        ...
        private void RefreshAvailableAssemblies()
        {
            try
            {
                ...
                var existingNames = new HashSet<string>(LoopMcpServerSettings.DefaultAssemblyNames);
